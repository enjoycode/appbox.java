package appbox.design.services.debug.variables;
...
import appbox.design.services.debug.DebugSettings;
import appbox.design.services.debug.formatter.NumericFormatEnum;
import appbox.design.services.debug.formatter.NumericFormatter;
import appbox.design.services.debug.formatter.SimpleTypeFormatter;
import appbox.design.services.debug.formatter.StringObjectFormatter;
...
public abstract class VariableUtils {
     ...
     * @param includeStatic whether or not the static fields are visible.
        ...
        List<Field> fields = type.allFields().stream().filter(t -> includeStatic || !t.isStatic())
                .sorted((a, b) -> {
                    try {
                        ...
                        Log.error(String.format("Cannot sort fields: %s", e));
                        return -1;
                    }
