...
public final class SignatureHelpHandler {
    private static final int SEARCH_BOUND = 2000;

    public static SignatureHelp signatureHelp(ICompilationUnit unit, int offset, IProgressMonitor monitor) {
    ...
    private static boolean isSameParameters(IMethod m, SignatureHelp help,
                                            SignatureHelpRequestor collector,
    ...
    private static boolean isSameParameters(IMethod method1, IMethod method2) {
    ...
    private static IMethod getMethod(ASTNode node) throws JavaModelException {
        IBinding binding;
    ...
    private static ASTNode getNode(ICompilationUnit unit, int[] contextInfomation, IProgressMonitor monitor) {
     ...
     */
    private static int[] getContextInfomation(IBuffer buffer, int offset) {
