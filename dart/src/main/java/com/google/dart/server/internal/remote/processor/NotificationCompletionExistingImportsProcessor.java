...
import org.dartlang.analysis.server.protocol.ExistingImports;
...
public class NotificationCompletionExistingImportsProcessor extends NotificationProcessor {
  ...
  public void process(JsonObject response) throws Exception {
    ...
    ExistingImports imports = ExistingImports.fromJson(paramsObject.get("imports").getAsJsonObject());
    getListener().computedExistingImports(file, imports);
